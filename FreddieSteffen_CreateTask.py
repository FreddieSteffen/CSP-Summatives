...
#Variables
global PlayerScore, DealerScore, PlayerBet, StartingCHips, Chips, CardSuit, CardName
...
def Make_TKinter_Elements():
  global root, button_frame, WelcomeLabel, QuestionLabel, StartButton, RulesButton, StartingTextName, NameEntry, PlayerName, RulesTitle, RulesLabel, BackButton, DealerLabel, PlayerLabel, HitButton, StandButton, NewGameButton, BlackjackLabel, StartingTextBet, BetEntry, PlayerBet, BetLabel, ChipsLabel
  root = tk.Tk()
  ...
  BackButton = tk.Button(button_frame, text="Back", command=lambda:OnClick("Back/New Game"))
  ...
  NewGameButton = tk.Button(button_frame, text="New Game", command=lambda:OnClick("Back/New Game"))
...
def on_enter(event):
  ...
  Chips = StartingChips - int(PlayerBet)
  BetEntry.delete(0, tk.END)
  BetEntry.insert(0, StartingTextBet)
  BetEntry.grid_remove()
